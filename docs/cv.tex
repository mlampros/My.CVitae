...
\begin{cventries}
    \cventry{ClusterR: Gaussian mixture models, k-means, mini-batch-kmeans, k-medoids and affinity propagation clustering}{L Mouselimis, C Sanderson, R Curtin, S Agrawal, B Frey, D Dueck}{R package}{2024}{}\vspace{-4.0mm}
    \cventry{elmNNRcpp: The extreme learning machine algorithm}{L Mouselimis, A Gosso}{R package}{2024}{}\vspace{-4.0mm}
    \cventry{KernelKnn: kernel k nearest Neighbors}{L Mouselimis}{R package}{2024}{}\vspace{-4.0mm}
    \cventry{OpenImageR: an image processing Toolkit}{L Mouselimis}{R package}{2024}{}\vspace{-4.0mm}
    \cventry{fastText: Efficient learning of word representations and sentence classification using R}{L Mouselimis}{R package}{2024}{}\vspace{-4.0mm}
    \cventry{VMDML: Variational Mode Decomposition Based Machine Learning Models}{P Das, GK Jha, T Ahmad, A Lama, L Mouselimis}{R package}{2024}{}\vspace{-4.0mm}
\end{cventries}
