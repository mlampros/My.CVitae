...
\begin{cventries}
    \cventry{ClusterR: Gaussian Mixture Models, K-Means, Mini-Batch-Kmeans, K-Medoids and Affinity Propagation Clustering. R Package Version 1.2. 2}{L Mouselimis, C Sanderson, R Curtin, S Agrawal, B Frey, D Dueck}{}{2020}{}\vspace{-4.0mm}
    \cventry{ClusterR: Gaussian mixture models, k-means, mini-batch-kmeans, k-medoids and affinity propagation clustering}{L Mouselimis}{R package version}{2019}{}\vspace{-4.0mm}
    \cventry{KernelKnn: Kernel k nearest neighbors}{L Mouselimis}{R package version}{2018}{}\vspace{-4.0mm}
    \cventry{elmNNRcpp: The Extreme Learning Machine Algorithm}{L Mouselimis, A Gosso}{R package}{2018}{}\vspace{-4.0mm}
    \cventry{Gosso A. elmNNRcpp: the extreme learning machine Algorithm}{L Mouselimis}{R package version}{2018}{}\vspace{-4.0mm}
    \cventry{OpenImageR: an image processing Toolkit}{L Mouselimis}{R package version}{2017}{}\vspace{-4.0mm}
    \cventry{ClusterR: Gaussian Mixture Models, K-Means, Mini-Batch-Kmeans, K-Medoids and Affinity Propagation Clustering; 2020}{L Mouselimis, C Sanderson, R Curtin, S Agrawal, B Frey, D Dueck}{R package version}{}{}\vspace{-4.0mm}
\end{cventries}
